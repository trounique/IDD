...
在 Flask 后端项目下启动后端代码：（就是在pycharm的终端中输入）

```bash
python app.py
```

在 VUE 前端项目下，先安装依赖：（在vue前端文件夹中打开命令行输入以下命令，需要提前装好vue环境。vue环境的安装见[vue.js 三种方式安装](https://blog.csdn.net/m0_37479246/article/details/78836686)，请用方式三安装）
